    ...
    return (
        <motion.div
            ...
            <motion.h4
                ...
                className='text-center mb-2 text-lg font-Outfit'>What I Offer</motion.h4>
            <motion.h2
            ...
            <motion.p
                ...
                I am a frontend developer from Nairobi, Kenya with a a 6 months experience in small organizations and startups.
                    ...
                    serviceData.map(({ icon, title, description, link }, index) => (
                        <motion.div
                         ...
                         hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white'>
                            ...
                            <a href={link}
                                className='flex items-center gap-2text-sm mt-5'>
                                Read more
                                <Image src={assets.right_arrow} alt='' className='w-4' /> </a>
                        </motion.div>
                    ))
                }
